...
lazy_static! {
 ...
 pub fn clean_vat_number(vat_number: &str) -> String {
     // maybe add 01 at the end of swedish code if len(vat_number) === 10?
...
#[cfg(test)]
mod tests {
    use super::{validate_format, clean_vat_number};

    #[test]
    fn test_validate_format_ok() {
        let numbers = vec![
            "ATU99999999",
            "BE1234567890", "BE0999999999",
            "BG1234567890",
            "HR12345678901",
            "CY12345678X",
            ...
            "PT123456789",
            // seriously romania
            "RO12", "RO123", "RO1234", "RO12345", "RO123456", "RO1234567", "RO12345678", "RO123456789", "RO1234567890",
            "SK1234567890",
            "SI12345678",
